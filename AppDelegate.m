...
- (void)letApplicationBackground{
    void (^letLayout)(UIView *) = ^(UIView *layoutView){
        [layoutView setTranslatesAutoresizingMaskIntoConstraints:NO];
        [self.window insertSubview:layoutView belowSubview:self.window.rootViewController.view];
        [layoutView.widthAnchor constraintEqualToAnchor:self.window.widthAnchor].active = YES;
        [layoutView.heightAnchor constraintEqualToAnchor:self.window.heightAnchor].active = YES;
        [layoutView.centerXAnchor constraintEqualToAnchor:self.window.centerXAnchor].active = YES;
        [layoutView.centerYAnchor constraintEqualToAnchor:self.window.centerYAnchor].active = YES;
    };
